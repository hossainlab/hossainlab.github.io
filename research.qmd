...
## Neuroepidemiology
::: {layout-ncol=2}
![](files/img/brains_banner.png){.lightbox}

![](files/img/brain_gif-maker.gif){.lightbox}
...
::: {layout-ncol=2}
![](files/img/plot_spectrum.png){.lightbox}

![](files/img/plot_compare_profiles.png){.lightbox}

![](files/img/mut_matrix.png){.lightbox}

![](files/img/plot_contribution_heatmap.png){.lightbox}
:::
